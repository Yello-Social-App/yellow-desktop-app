...
export const IPC_CHANNELS = {
  ...
  AUTH_CHANGE_PASSWORD_OTP: 'auth:change-password-otp',
  ...
  POSTS_TOGGLE_SAVE: 'posts:toggle-save',
  POSTS_LIST_SAVED: 'posts:list-saved',
  ...
  STORIES_MINE: 'stories:mine',
  STORIES_OF_USER: 'stories:of-user',
  STORIES_GET: 'stories:get',
  STORIES_CREATE: 'stories:create',
  STORIES_MARK_SEEN: 'stories:mark-seen',
  STORIES_VIEWERS: 'stories:viewers',
  STORIES_ARCHIVE: 'stories:archive',
  STORIES_DELETE: 'stories:delete',
  STORIES_REPLY: 'stories:reply',
